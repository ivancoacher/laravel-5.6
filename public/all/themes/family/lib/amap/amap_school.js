...
//        }
       ...
       var marker= new AMap.Marker({ //添加自定义点标记
            ...
            offset: new AMap.Pixel(-17, -42), //相对于基点的偏移位置
            draggable: false,  //是否可拖动
            content: '<div class="marker-route marker-marker-bus-from">  <img src="'+map_image+'" class="map-img-item-school" /><div class="title_school_adress">'+ item.title +'</div></div>'   //自定义点标记覆盖物内容
        });
        if(item.url == ""){  
